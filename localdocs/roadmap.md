...
| 006 | Plane-change maneuvers (+ combined transfer+plane change) | Cost of changing inclination & the global optimum vs bi-elliptic super-synchronous | **COMPLETE** (2026-08-16): three regimes (two-burn / finite-s 3-burn / s→∞), boundaries di_c(R), di_inf(R); finite-s window pinches shut at R≈6.43; s→∞ limit = Exp 005 bi-parabolic (1e-16); R=2,Δi=47.5° finite dip beats two-burn 1.77%; SES-8 super-sync anchor wins 5.21%; 3D RK4 validation (≤1e-11); 14 tests |
