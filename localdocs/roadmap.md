...
| 018 | (proposed) Refined Lunisolar evection + variation terms OR Sentinel/Landsat byte-pinning OR (deferred) decadal station-keeping | Build on the measured ~170x Lunisolar over-estimate factor | not yet started |
