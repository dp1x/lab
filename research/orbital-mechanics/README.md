...
| 016 | SSO LST-drift correction | **complete** (2026-08-30) | First-principles EoT envelope + J2 closure + Lunisolar upper-bound + SRP + drag decomposition over 1-5 year arcs at h in {500,600,700,800} km. EoT ptp 30.65 min (validated vs byte-pinned 2026 Sun snapshot to 0.056 deg); J2 closure residual ~2.2 deg/year; Lunisolar closed-form upper bound reported as conservative ceiling; total Δv range at h=600 km [0, ~10.6 km/s/yr]; 4 figures; 40 new tests |
| 017 | Lunisolar upper-bound verification | **complete** (2026-08-30) | Byte-pinned JPL Horizons DE441 geocentric Moon vectors (76 KB, sha256 `65f1d67f...`); numerical integration of Kepler + J2 + point-mass Sun + Moon at h in {500,600,700,800} km over 1 year; J2-only control subtraction (model-order separation); SIGNED RATIO cf_upper/numerical = ~170x at h=600 km (cf retrograde -0.218 deg/day, numerical prograde +0.00128 deg/day); ~3x larger than audit-015 ~50x estimate (documented as first-principles discovery); RK4 self-convergence p=4.49; rejects original decadal direction as not scientifically defensible (8-track audit unanimous); 4 figures; 32 new tests |
| 018+ | Refined Lunisolar evection+variation OR Sentinel/Landsat byte-pinning OR (deferred) decadal station-keeping | planned | build on measured ~170x over-estimate factor |
